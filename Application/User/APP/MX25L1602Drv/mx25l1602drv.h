...
**********************************************************************************************************/
extern   INT08U MX25L1602_RD(INT32U Dst, INT32U NByte,INT08U* RcvBufPt);
...
*********************************************************************************************************/
extern   INT08U MX25L1602_RdID(idtype IDType, INT32U* RcvbufPt);
...
** 特殊说明:若某功能下,某一入口参数无效,可在该入口参数处填Invalid，该参数将被忽略
*********************************************************************************************************/
extern   INT08U MX25L1602_WR(INT32U Dst,INT08U* SndbufPt,INT32U NByte);
...
** 输出参数:操作成功则返回OK,失败则返回ERROR_0
*********************************************************************************************************/
extern  INT08U MX25L1602_Erase(INT32U sec1, INT32U sec2);
